 ...
 * This JiraTicketsPlotterMain uses the library form Apache for Command Line Interface:
 * <a href="https://commons.apache.org/proper/commons-cli/usage.html">commons-cli</a>
 */
public class JiraTicketsPlotterMain {

  static CommandLine commandLine;
  static Logger log = LogManager.getLogger(JiraTicketsPlotterMain.class);
  ...
  static void printHelp(Options options) {
    ...
    String className = JiraTicketsPlotterMain.class.getCanonicalName();
